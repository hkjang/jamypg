...
MariaDB**. Current source version: `v0.55.0` (converted from the Oracle-based
jasql project).
...
| 컨테이너 (모든 DB 실행 가능) | `docker build -t jamypg-mcp:v0.55.0 .` |
...
```sh
docker build -t jamypg-mcp:v0.55.0 .
