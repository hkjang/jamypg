...
| 메타데이터 품질·보강 | `get_metadata_quality` → [metadata-quality.md](metadata-quality.md), `suggest_semantic_metadata` → [metadata-enrich.md](metadata-enrich.md), `suggest_model_candidates` → [metadata-candidates.md](metadata-candidates.md) |
