    ...
    "/api/settings": {
      ...
      "put": {
        ...
        "requestBody": { "required": true, "content": { "application/json": { "schema": {"type":"object","additionalProperties":{"type":["string","null"]}},
          "examples": { "oidc": { "value": { "oidc_issuer":"https://kc/realms/x","oidc_client_id":"jamypg","oidc_client_secret":"...","oidc_redirect_url":"https://host:9797/auth/sso/callback" } } } } } },
