...
// PostgreSQL, MySQL, and MariaDB. MariaDB shares the MySQL wire protocol and
...
var SupportedTypes = []string{"postgres", "mysql", "mariadb"}
...
func DialectFor(typ string) (Dialect, error) {
	...
	default:
		return nil, fmt.Errorf("unsupported db type %q (use postgres, mysql, or mariadb)", typ)
	}
}
